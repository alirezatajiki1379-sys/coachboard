  ...
  return (
    <div className="space-y-6">
      <div className="flex flex-col gap-4 md:flex-row md:items-start md:justify-between">
        ...
        <ButtonLink href="/squad/attendance/new" className="justify-center">
      ...
      <section className={events.length ? "space-y-4" : ""}>
        {events.length ? (
          events.map((event) => <TrainingEventCard key={event.id} event={event} attendance={event.attendance} />)
        ) : (
          <div className="rounded-lg border border-dashed border-board-line bg-white p-8 text-center shadow-soft">
            ...
            <ButtonLink href="/squad/attendance/new" className="mt-5">
