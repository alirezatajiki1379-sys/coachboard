...
export function mapSquadPlayerRow(row: SquadPlayerRow): SquadPlayer {
  return {
    ...
    addressStreet: optional(row.address_street),
    addressPostalCode: optional(row.address_postal_code),
    addressCity: optional(row.address_city),
    position: optional(row.position),
    positionFamilies: Array.isArray(row.position_families) ? row.position_families : [],
    ...
    trialDurationMode: row.trial_duration_mode ?? undefined,
    trialTrainingLimit: row.trial_training_limit ?? undefined,
    trialEndDate: optional(row.trial_end_date),
    playerEmail: optional(row.player_email),
    secondaryEmail: optional(row.secondary_email),
    ...
    exitDate: optional(row.exit_date),
    exitReason: optional(row.exit_reason),
    scoutingSource: optional(row.scouting_source),
    developmentCentre: optional(row.development_centre),
    lastPerformanceReviewDate: optional(row.last_performance_review_date),
