...
create table if not exists public.squad_players (
  ...
  address_city text,
  position text,
  position_families text[] not null default '{}',
...
drop trigger if exists set_training_event_groups_updated_at
on public.training_event_groups;
...
alter table public.training_event_groups
enable row level security;

alter table public.training_event_group_members
enable row level security;
...
-- TRAINING EVENT GROUPS

drop policy if exists "training event groups are owned by the user"
on public.training_event_groups;
...
drop policy if exists "training event group members are owned by the user"
on public.training_event_group_members;
...
-- =========================================================
-- PLAYER DEVELOPMENT GOALS & PROGRESS TRACKING
-- =========================================================
...
-- =========================================================
-- SESSION REVIEW & COACH REFLECTION
-- =========================================================
